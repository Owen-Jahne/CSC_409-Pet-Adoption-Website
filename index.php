...
{
	print("<tr><td>".$value['Animal_Type']."</td><td class=\"count\">".number_format($value['Age_Months'])."</td><td>".$value['Pet_Size']."</td><td>".$value['Breed']."</td><td>".$value['Color']."</td><td".$value['Sex']."</tr></td>\n");
}
